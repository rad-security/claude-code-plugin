#!/usr/bin/env bash
# run-all.sh — Master test runner for AgentKeeper Claude Code plugin
...
echo ""
printf "${BOLD}AgentKeeper Plugin — Test Runner${NC}\n"
echo "========================================"
echo ""
...
run_suite "Windsurf Adapter" "${SCRIPT_DIR}/test-windsurf-adapter.sh"
