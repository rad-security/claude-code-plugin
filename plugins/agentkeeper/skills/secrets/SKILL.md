...
- Example: `AKIA...CDEF` becomes `AKIA**************EF`
- Example: `sk_live_...z789` becomes `sk_l***************89`
...
Consider running /agentkeeper:audit for a full setup compliance check.
```
